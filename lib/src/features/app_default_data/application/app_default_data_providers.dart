...
final remoteAppDefaultDataRepositoryProvider = Provider<IAppDefaultDataRepository>((ref) {
...
final getStatuses = Provider<GetStatuses>((ref) {
  final defaultDataRepository = ref.watch(remoteAppDefaultDataRepositoryProvider);
    return GetStatuses(appDefaultDataRepository: defaultDataRepository);
});

final getSubscriptions = Provider<GetSubscriptions>((ref) {
  final defaultDataRepository = ref.watch(remoteAppDefaultDataRepositoryProvider);
    return GetSubscriptions(appDefaultDataRepository: defaultDataRepository);
});
