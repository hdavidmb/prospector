...
part of 'change_password_form_state.dart';
...
mixin _$ChangePasswordFormState {
  ...
  bool get showPasswords => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      confirmNewPassword: confirmNewPassword == freezed
          ...
          : confirmNewPassword // ignore: cast_nullable_to_non_nullable
              as String,
      showPasswords: showPasswords == freezed
          ? _value.showPasswords
          : showPasswords // ignore: cast_nullable_to_non_nullable
              as bool,
...
class _$_ChangePasswordFormState implements _ChangePasswordFormState {
  ...
  @override
  String toString() {
    return 'ChangePasswordFormState(currentPassword: $currentPassword, newPassword: $newPassword, confirmNewPassword: $confirmNewPassword, showPasswords: $showPasswords, showErrorMessages: $showErrorMessages, isSubmitting: $isSubmitting, failureOption: $failureOption)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _ChangePasswordFormState &&
            ...
            (identical(other.showPasswords, showPasswords) ||
                const DeepCollectionEquality()
                    .equals(other.showPasswords, showPasswords)) &&
  ...
  int get hashCode =>
      ...
      const DeepCollectionEquality().hash(showPasswords) ^
